    ...
    SELECT -1 DOKID, 'FV' TYPDOK, KONTRAHID, CZYZPAR, KONTRAHNAZWA, ULICANR, KODPOCZTOWY, MIEJSCOWOSC, nvl(KODKRAJU,'-') AS KODKRAJU, nvl(NIP,'-') AS NIP, FIRMA, NRDOK, DATASPRZEDAZY, DATA, NETTO, BRUTTO, VAT, NETTO_A, BRUTTO_A, VAT_A,
...
AND TO_DATE('dataDo 23:59:59',  'YYYY-MM-DD HH24:MI:SS')
        ...
        ORDER BY F.DATA)
UNION ALL
    SELECT -1 DOKID, 'FVK' TYPDOK, KONTRAHID, CZYZPAR, KONTRAHNAZWA, ULICANR, KODPOCZTOWY, MIEJSCOWOSC, nvl(KODKRAJU,'-') AS KODKRAJU, nvl(NIP,'-') AS NIP, FIRMA, NRDOK, DATASPRZEDAZY, DATA, NETTO, BRUTTO, VAT, NETTO_A, BRUTTO_A, VAT_A,
        NETTO_B, BRUTTO_B, VAT_B, NETTO_C, BRUTTO_C, VAT_C, NETTO_D, BRUTTO_D, VAT_D, NETTO_E, BRUTTO_E, VAT_E, NETTO_F, BRUTTO_F, VAT_F, NETTO_Z, BRUTTO_Z, VAT_Z, NETTO_NP, BRUTTO_NP, VAT_NP
