...
namespace FvpWebApp.Data.Migrations
{
    ...
    [Migration("20201121190317_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FvpWebAppModels.Models.TargetDocumentSettings", b =>
                {
                    ...
                    b.HasIndex("DocumentShortcut")
                        .IsUnique()
                        .HasName("IX_DocSettingsShortcut")
                        .HasFilter("[DocumentShortcut] IS NOT NULL");
            ...
            modelBuilder.Entity("FvpWebAppModels.Models.VatRegister", b =>
                {
                    b.Property<int>("VatRegisterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ErpVatRegisterId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("VatRegisterId");

                    b.HasIndex("TargetDocumentSettingsId", "VatValue")
                        .IsUnique()
                        .HasName("IX_VatValueOnTargetDocument");

                    b.ToTable("VatRegisters");
                });
            ...
            modelBuilder.Entity("FvpWebAppModels.Models.VatRegister", b =>
                {
                    b.HasOne("FvpWebAppModels.Models.TargetDocumentSettings", null)
                        .WithMany("VatRegisters")
                        .HasForeignKey("TargetDocumentSettingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
